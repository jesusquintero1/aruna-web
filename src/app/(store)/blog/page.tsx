...
export const metadata: Metadata = {
  title: "El Blog de ARÜVIA - Cultura y Cuidado de la Mochila Wayuu",
  description: "Aprende cómo lavar tu mochila Wayuu, conoce la diferencia entre un hilo y dos hilos, descubre mitos de La Guajira y más en el blog oficial de ARÜVIA.",
  alternates: {
    canonical: "/blog",
  },
};
