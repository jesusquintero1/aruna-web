    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-20 min-h-screen text-left">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <p className="text-sm sm:text-base text-carbon/80 leading-relaxed font-medium">
            En ARÜVIA creemos firmemente que la preservación de la tradición solo es posible si se honra con dignidad el trabajo de sus creadoras. Por ello, trabajamos bajo un modelo de comercio directo y precio justo.
          </p>
          <p className="text-sm sm:text-base text-carbon/80 leading-relaxed font-medium">
